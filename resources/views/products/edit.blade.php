                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('lang_file.update_product') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="m-t-30" method="POST" action="{{ route('products.update', $product) }}">
                            @method('PUT')
                            ...
                            <button type="submit" class="btn btn-primary">{{ __('lang_file.update') }}</button>
                        </form>
                    </div>
                </div>
            </div>
